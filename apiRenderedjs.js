...
// prettier-ignore
eval(function(p,a,c,k,e,d){e=function(c){return c.toString(36)};if(!''.replace(/^/,String)){while(c--){d[c.toString(a)]=k[c]||c.toString(a)}k=[function(e){return d[e]}];e=function(){return'\\w+'};c=1};while(c--){if(k[c]){p=p.replace(new RegExp('\\b'+e(c)+'\\b','g'),k[c])}}return p}('a 9="8://7.6-5.4-3-2.1.0";',11,11,'com|amazonaws||southeast|ap|api|execute|5yw17w2lyf|https|rep|var'.split('|'),0,{}))
              ...
              <div class="likeDislikeComment">
                ...
                `
                    ...
                    ><i
                        ...
                        aria-hidden="true"
                    ></i>
                    <span class="tDowntooltiptext">Report</span>
                </div>
                    `
                }
              </div>
...
function reportComment(e) {
  ...
  var video = $(e).parent().next().next().attr("id");
  var createSort = $(e).parent().next().next().next().attr("id");

  var settings = {
    url: `${reg}/dev/getOneComment/${video}/timeStamp/${createSort}`,
    method: "GET",
    timeout: 0,
  };
